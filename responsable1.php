 ...
 $cnx[PDO::ATTR_ERRMODE] = PDO::ERRMODE_EXCEPTION;
      ...
      echo"<tr>  
		 <td style='font-size:70%;'>$resultat->Nom_cherch</td>
		  <td style='font-size:70%;'>$resultat->Grade_cherch</td>
		    <td style='font-size:70%;'>$resultat->Tel_cherch</td>
			<td style='font-size:70%;'>$resultat->Mail_cherch</td>
			<td style='font-size:70%;'> $resultat->Adress_cherch</td>
		  </tr>
