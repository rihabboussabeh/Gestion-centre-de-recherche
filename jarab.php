...
<br> 
  <img id="im"  src="labo.jpg"  />
   ...
   box-shadow: 0px 0px 20px #888888;
	">
                <section id="cestquoi">
                   			    <form   action="ajmissjjj.php"     method="GET" >
                    ...
                    <h1 style="color:#5a91bf">Ajouter mission<h1>
                        ...
                        <input style="background-color:#c7d7ef ;border: inset ;padding:2%;width:85%  "  type="text"  placeholder="Destination" name="Destination" id="Destination"/> 
              
                <input   style="background-color:#c7d7ef ;border: inset ;padding:2%;width:85%;margin-top:5% "   type="text"   placeholder="Objectif" name="Objectif" id="Objectif" /> 
