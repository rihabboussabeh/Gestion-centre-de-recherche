...
<br> 
  <img id="im"  src="labo.jpg"  />
   ...
   box-shadow: 0px 0px 20px #888888;
	">
                <section id="cestquoi">
                   			    <form   action="ajmiss.php"     method="GET" >
         
               
                   
                     
                    <h1 style="color:#5a91bf">Ajouter mission<h1>
                     
                        <input style="background-color:#c7d7ef ;border: inset ;padding:2%;width:85%  " pattern='[A-Za-z]{3,}' required title="au moins 3 caractères!"  type="text"  placeholder="Destination" name="Destination" id="Destination"/> 
              
                <input   style="background-color:#c7d7ef ;border: inset ;padding:2%;width:85%;margin-top:5% " pattern='[A-Za-z]{3,}' required title="au moins 3 caractères!"  type="text"   placeholder="Objectif" name="Objectif" id="Objectif" /> 
               ...
               <br>
                   ...
                   <input type="submit"    style="background-color:#5a91bf;border: 1px outset;padding:3%; margin-left:65% ;color:#e6e6e6 "  value="Ajouter mission"  name="ajout" >
