...
<br> 
  <img id="im"  src="labo.jpg"  />
   ...
   box-shadow: 0px 0px 20px #888888;
	">
                <section id="cestquoi">
                   			    <form  action="ajart.php"     method="GET">
                ...
                <input   style="background-color:#c7d7ef ;border: inset ;padding:2%;width:85%;margin-top:5% "   type="text" pattern='[A-Za-z]{3,}' required title="au moins 3 caractères!"  placeholder="Nom de conférence" name="Nom_conf" id="Nom_conf" /> 
                  ...
                  <input   style="background-color:#c7d7ef ;border: inset ;padding:2%;width:85%;margin-top:5% "   type="number"  required placeholder="nombres de page" name="nb_page" id="nb_page" /> 
	  ...
	  $resultat = $resultats->fetch() ;
               ...
               <br>
                     ...
                     <br>
                 <input type="submit" name="ajout"   style="background-color:#5a91bf;border: 1px outset;padding:3%; margin-left:65% ;color:#e6e6e6 "  value="ajouter" >
